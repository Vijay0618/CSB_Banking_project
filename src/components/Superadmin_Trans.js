...
import UpdateComplaint from "./UpdateComplaint";
 ...
 function Complaintbydepts_superT() {
  ...
  <div >
      <br></br>
    <h1 style={{ textAlign: 'center' }}>Welcome To Transaction Complaints Department of CSB</h1>
    ...
    <th scope='col'>Complain Id</th>       
     ...
     export default Complaintbydepts_superT;