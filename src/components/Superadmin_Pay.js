...
import UpdateComplaint from "./UpdateComplaint";
 ...
 function Complaintbydepts_superP() {
  ...
  function getUsers() {
    fetch("https://localhost:7284/api/Complaint/Getdept/Payment").then((result) => {
  ...
  return (
    ...
    <div >
        <br></br>
      <h1 style={{ textAlign: 'center' }}>Welcome To Payment Complaints Department of CSB</h1>
      ...
      <th scope='col'>Complain Id</th>       
          ...
          <th scope='col'>Complaint Desc.</th>
     ...
     export default Complaintbydepts_superP;