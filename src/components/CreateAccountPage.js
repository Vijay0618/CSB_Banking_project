    ...
    return (
        <section id="main-content">
            <form id="form" onSubmit={handleCreateAccount}>
                ...
                <input id="account-number" name="accountNumber" className="right" value={initialAccountNumber} type="number" disabled required/>

                <label htmlFor="balance">Initial balance</label>
                <input id="balance" type="text" value={formatNumber(initialBalance)} onChange={onInitialBalance} name="initialBalance" className="right" required/>

                <label htmlFor="account-type">Account Type</label>
                <select name="accountType">
                    <option value="Checking Account">Current Account</option>
                ...
                <input value="Create Account" type='submit' className="btn"/>
            </form>
        </section>
    )
}
